...
| | |
|---|---|
| <img src="docs/screenshots/chat.png" alt="智能体对话" /> | <img src="docs/screenshots/kanban.png" alt="看板" /> |
| **对话** -- 流式输出、视觉理解、语音、文件附件 | **看板** -- 智能体间拖拽式任务管理 |
| <img src="docs/screenshots/pipelines.png" alt="流水线" /> | <img src="docs/screenshots/cron-schedule.png" alt="调度计划" /> |
| **流水线** -- 带健康检查的 DAG 可视化 | **计划** -- 周热力图和任务管理 |
| <img src="docs/screenshots/activity.png" alt="活动控制台" /> | <img src="docs/screenshots/live-logs.png" alt="实时日志" /> |
| **活动** -- 历史日志浏览器，支持 JSON 展开 | **实时日志** -- 实时流式日志组件 |
| <img src="docs/screenshots/costs.png" alt="成本仪表盘" /> | <img src="docs/screenshots/memory.png" alt="记忆浏览器" /> |
| **成本** -- Token 使用量、异常检测、优化建议 | **记忆** -- 团队记忆浏览器，支持 Markdown 渲染 |
